...
import { GetConfiguration, GetNitroInstance, GetSessionDataManager, LocalizeBadgeDescription, LocalizeBadgeName, LocalizeText } from '../../api';
...
export const LayoutBadgeImageView: FC<LayoutBadgeImageViewProps> = props =>
{
    ...
    const getStyle = useMemo(() =>
    {
        ...
        if(imageElement)
        {
            newStyle.backgroundImage = `url('${ GetNitroInstance().getConfiguration<string>('badge.asset.url').replace('%badgename%', badgeCode) }')`;
